...
class Login extends Component
{
    ...
    {
        return view("pages.organization.authentication.login")->layout("segments.organization.login-layout");
    }
    ...
    public function save(Request $request)
    {
        ...
        if (!Auth::guard("organization")->attempt(["email" => $this->email, "password" => $this->password], $this->remember)) {
