...
!(function (e) {
    ...
    function c(e) {
        ...
        return (
            (function a(e, n) {
                for (var i = e.firstChild; i; i = i.nextSibling) 3 == i.nodeType ? (n += i.nodeValue.length) : 1 == i.nodeType && (t.push({ event: "start", offset: n, node: i }), (n = a(i, n)), r(i).match(/br|hr|img|input/) || t.push({ event: "stop", offset: n, node: i }));
                return n;
            })(e, 0),
            t
        );
