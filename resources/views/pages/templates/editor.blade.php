<x-container>
    ...
    <span class="preheader">Thanks for trying out [Product Name]. We’ve pulled together some information and
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <x-ui.form.field-editor id="template" name="template"
                                            ...
                                            <p>You've started a {trial_length} day trial. You can upgrade to a paying
                                                account or cancel any time.</p>
                                            <table class="attributes" width="100%" cellpadding="0" cellspacing="0"
                                                role="presentation">
                                                <tr>
                                                    <td class="attributes_content">
                                            ...
                                            <p>If you have any questions, feel free to <a
                                                    href="mailto:{support_email}">email our customer success team</a>.
                                                (We're lightning quick at replying.) We also offer <a
                                            ...
                                            <p><strong>P.S.</strong> Need immediate help getting started? Check out our
                                                <a href="{help_url}">help documentation</a>. Or, just reply to this
                                                email, the [Product Name] support team is always ready to help!
                                            </p>
                                            <!-- Sub copy -->
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; 2021 [Product Name]. All rights
                                            reserved.</p>
