@php
$style_bold = 'bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500';
$style_normal = 'appearance-none outline-none focus:ring-2  focus:shadow-inner shadow-sm ring-gray-300 focus:border-gray-400 block w-full bg-white text-gray-500 text-sm border border-gray-100 rounded py-3 px-4';
@endphp

<div x-data="{ search: '', find(){

$wire.set('bus.search','hello')


 }, options: [ {'name':'dr who'} ] }">
    <input type="text" x-model="search" x-on:change="find()"
        class="{{ isset($bold) ? $style_bold : $style_normal }}" />
    @if (optional($this->bus)['search'])
        <div>searched</div>
    @endif
    <div>
    ...
    <div class="relative">
        ...
        <div x-show="open" @focusout="onEscape()" @click.away="open = false"
            ...
            <ul @keydown.enter.stop.prevent="onOptionSelect()" @keydown.space.stop.prevent="onOptionSelect()"
                ...
                <li id="assigned-to-option-6" role="option" @click="choose(6)" @mouseenter="selected = 6"
                    @mouseleave="selected = null"
                ...
                <li id="assigned-to-option-7" role="option" @click="choose(7)" @mouseenter="selected = 7"
                    @mouseleave="selected = null"
                ...
                <li id="assigned-to-option-8" role="option" @click="choose(8)" @mouseenter="selected = 8"
                    @mouseleave="selected = null"
                ...
                <li id="assigned-to-option-9" role="option" @click="choose(9)" @mouseenter="selected = 9"
                    @mouseleave="selected = null"
                ...
                <li id="assigned-to-option-10" role="option" @click="choose(10)" @mouseenter="selected = 10"
                    @mouseleave="selected = null"
