@if (isset($errors) && $attributes->has('wire:model'))
    @error($attributes->get('wire:model')) 
        <span class="select-none text-yellow-500 text-xs flex items-start leading-5 mt-2 font-semibold animate-animated animate-faster animate-fadeInDown">
            <svg class="h-5 w-5 mr-0.5 flex-shrink-0" fill="currentColor" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 100"  xml:space="preserve">
                <g>
                    <g>
