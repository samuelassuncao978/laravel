...
export default function E404(): JSX.Element {
    return (
        <div className="container mx-auto flex flex-col md:flex-row items-center my-32">
            <div className="w-full md:w-1/2 h-32 md:h-full">
                <div className="flex h-full overflow-hidden items-stretch justify-center text-blue-500">
                    <svg
            ...
            <div className="w-full md:w-1/2">
                <div className="p-10 flex flex-col items-center md:items-start">
                    <div className="mb-10">
                        <div className="h-14 flex">
                            <img
                                src="https://d2k0anb7jgvne3.cloudfront.net/fbd373ed-cdfb-46d6-9970-1d193f4a3868/images/logo.png"
                                alt=""
                            />
                        </div>
                    </div>
                    <h1 className="text-6xl max-w-lg text-gray-800">404</h1>
                    <h2 className="text-2xl max-w-lg text-gray-800">UH OH! You're lost.</h2>
                    <p className="max-w-lg text-gray-800 mt-4 md:text-left text-center">
