...
return [
    ...
    "strategies" => [
        "metadata" => [\Mpociot\ApiDoc\Extracting\Strategies\Metadata\GetFromDocBlocks::class],
        "urlParameters" => [\Mpociot\ApiDoc\Extracting\Strategies\UrlParameters\GetFromUrlParamTag::class],
        "queryParameters" => [\Mpociot\ApiDoc\Extracting\Strategies\QueryParameters\GetFromQueryParamTag::class],
        "headers" => [\Mpociot\ApiDoc\Extracting\Strategies\RequestHeaders\GetFromRouteRules::class],
        "bodyParameters" => [\Mpociot\ApiDoc\Extracting\Strategies\BodyParameters\GetFromBodyParamTag::class],
        "responses" => [\Mpociot\ApiDoc\Extracting\Strategies\Responses\UseTransformerTags::class, \Mpociot\ApiDoc\Extracting\Strategies\Responses\UseResponseTag::class, \Mpociot\ApiDoc\Extracting\Strategies\Responses\UseResponseFileTag::class, \Mpociot\ApiDoc\Extracting\Strategies\Responses\UseApiResourceTags::class, \Mpociot\ApiDoc\Extracting\Strategies\Responses\ResponseCalls::class],
    ],
